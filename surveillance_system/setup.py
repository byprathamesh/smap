...
# Configuration: Vetted URLs and Expected Content-Types for Verification
MODELS_CONFIG = [
    {
...
def check_and_download_models():
    print_header("Step 1: Verifying AI Models with Content-Type Check")
    ...
    for model in MODELS_CONFIG:
        ...
        try:
            ...
            if content_type != model['content_type']:
                print(f"  -> [ERROR] Download failed: Expected content type '{model['content_type']}' but got '{content_type}'. This is likely an HTML error page.")
    ...
    if not all_models_valid:
        print("\n[FATAL ERROR] One or more models could not be correctly downloaded.")
